...
{
    public class HotbarSlot : ItemSlotUI, IDropHandler, ItemContainer
    {
    ...
    [SerializeField] private Inventory inventory = null;
        ...
        private void SetItemQuantityUI()
        {
            if (SlotItem is InventoryItem inventoryItem)
            {
                ...
                if (Inventory.instance.ItemContainer.HasItem(inventoryItem)) 
                {
                    int quantityCount = Inventory.instance. ItemContainer.GetTotalQuantity(inventoryItem);
